...
class ProjectCategory(models.Model):
    ...
    the_area_filter = models.PositiveIntegerField(
        blank=True,
        null=True,
        verbose_name="Начниается от скольки метров в квадрате"
        )
    price_filter = models.DecimalField(
        blank=True,
        null=True,
        max_digits = 15,
        decimal_places=0,
        verbose_name="Начиная от какой суммы"
        )
